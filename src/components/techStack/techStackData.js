...
import Azure from '../../images/icons/Azure1.png';
...
const tools = [
  ...
  { src: Azure, alt: 'Azure Icon', name: 'Azure' },
  { src: Docker, alt: 'Docker Icon', name: 'Docker' },
...
const allTools = [
  ...
  { src: javascriptIcon, alt: 'JS Icon', name: 'Javascript' },
